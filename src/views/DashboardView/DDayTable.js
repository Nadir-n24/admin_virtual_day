...
const headCells = [
  {
    id: 'name', numeric: false, disablePadding: true, label: 'Мероприятие'
  },
  {
    id: 'day_date', numeric: false, disablePadding: true, label: 'Дата'
  },
];
          ...
          <Tooltip title="Edit">
            <IconButton aria-label="edit">
              ...
              <Dialog open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title">Обновить дату ДОД</DialogTitle>
                <DialogContent>
                  <DialogForm />
                </DialogContent>
                <DialogActions>
